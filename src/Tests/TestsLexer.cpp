...
void DoubleSignTest() {
    Compiler comp ("tests/lexer/double_sign.txt");
...
void IdentifierTest () {
    Compiler comp ("tests/lexer/identifier.txt");
    std::vector<Token>& tokenList = comp.getTokenList();
...
void DecimalTest () {
    Compiler comp ("tests/lexer/digit.txt");
    std::vector<Token>& tokenList = comp.getTokenList();
...
void DQuotesTest () {
    Compiler comp ("tests/lexer/dquotes.txt");
    std::vector<Token>& tokenList = comp.getTokenList();
